...
SECRET_KEY = 'django-insecure-qy^i6)by4&(2%-un2$$(=_hnn06r-$27*$4m!=cn0346pr2x-5'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*'] # Para pruebas está bien, en producción se debe especificar quienes pueden hacer solicitudes al servidor
